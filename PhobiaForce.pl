...
#
# Usage:
# perl PhobiaForce.pl login wordlist
# login Menggunakan Email id ataupun no Hp
#
# Module Requirements:
#
...
#
# Demo:
# perl PhobiaForce.pl Facebooklogin@facebook.com wordlist.lst
#
# --- PhobiaForce password cracking tool
# --- PhobiaXploit
# --- phobiaxploit@gmail.com
#
...
#
########################################################
# [+] Ditemukan! password nya Senyum Oh :D P@$$W0RD
########################################################
#
